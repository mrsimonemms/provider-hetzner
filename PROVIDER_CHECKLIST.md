...
The [provider-hetzner](https://github.com/crossplane/provider-hetzner) repository can be
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/crossplane/provider-hetzner/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/crossplane/provider-hetzner/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/crossplane/provider-hetzner/blob/main/hack/boilerplate.go.txt](https://github.com/crossplane/provider-hetzner/blob/main/hack/boilerplate.go.txt)
...
The [provider-hetzner](https://github.com/crossplane/provider-hetzner)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/crossplane/provider-hetzner/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/crossplane/provider-hetzner/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue hetzners (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/crossplane/provider-hetzner/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request Hetzners: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/crossplane/provider-hetzner/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
